...
from app.crud.demoUser_crud import DemoUserCRUD
from app.models.demoUser import DemoUser, DemoUserCreate, DemoUserListResponse, DemoUserUpdate
...
def list_items(
    ...
    if sortField and sortOrder:
        field = getattr(DemoUser, sortField, None)
...
def get_item(item_id: int, session: Session = Depends(get_session)):
    ...
    if not item:
        raise HTTPException(status_code=404, detail="DemoUser not found")
    return item
