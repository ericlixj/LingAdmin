...
from app.crud.crudDefineFileds_crud import CrudDefineFiledsCRUD
from app.models.crudDefineFileds import CrudDefineFileds, CrudDefineFiledsCreate, CrudDefineFiledsListResponse, CrudDefineFiledsUpdate
...
def get_item(item_id: int, session: Session = Depends(get_session)):
    ...
    if not item:
        raise HTTPException(status_code=404, detail="CrudDefineFileds not found")
    return item
