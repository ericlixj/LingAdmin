...
class MulCurdModelOrder03(SQLModel, table=True):
...
class MulCurdModelOrder03Create(SQLModel):
    user_id: int
    order_code: str
...
class MulCurdModelOrder03Update(SQLModel):
...
class MulCurdModelOrder03ListResponse(SQLModel):
    data: List[MulCurdModelOrder03]
    total: int