...
class MulCurdModelOrder(SQLModel, table=True):
...
class MulCurdModelOrderCreate(SQLModel):
    user_id: int
    order_code: str
...
class MulCurdModelOrderUpdate(SQLModel):
...
class MulCurdModelOrderListResponse(SQLModel):
    data: List[MulCurdModelOrder]
    total: int