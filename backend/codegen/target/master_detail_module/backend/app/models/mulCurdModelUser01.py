...
class MulCurdModelUser01(SQLModel, table=True):
...
class MulCurdModelUser01Create(SQLModel):
    user_name: str
    user_code: str
...
class MulCurdModelUser01Update(SQLModel):
...
class MulCurdModelUser01ListResponse(SQLModel):
    data: List[MulCurdModelUser01]
    total: int