...
export const MulCurdModelUser03Edit = () => {
    ...
    <Edit saveButtonProps={saveButtonProps}>
      <Form {...formProps} layout="vertical" onFinish={handleFinish}>
        <Form.Item
          ...
          label="用户名称"
          rules={[
{ required: true, message: '请输入用户名称' },            { max: 50, message: '最多输入 50 个字符' },
          ]}
        >
            <Input />
        </Form.Item>
