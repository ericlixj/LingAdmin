...
export const MulCurdModelUser03List = () => {
    ...
    <List>
      <Table {...tableProps} rowKey="id">
        ...
        <Table.Column
          ...
          filteredValue={
            (filters.find((f) => f.field === "user_name")?.value as any[]) || null
          }
        ...
        <Table.Column
          ...
          filteredValue={
            (filters.find((f) => f.field === "user_code")?.value as any[]) || null
          }
        ...
        <Table.Column
          ...
          filteredValue={
            (filters.find((f) => f.field === "user_status")?.value as any[]) || null
          }
