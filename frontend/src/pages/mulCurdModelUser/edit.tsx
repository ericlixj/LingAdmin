...
const fields = [{"common": true, "default": null, "description": "\u4e3b\u952e", "form_type": "input", "index": false, "insertable": true, "listable": true, "max_length": null, "name": "id", "nullable": false, "options": null, "primary_key": true, "query_type": null, "queryable": false, "required": true, "sortable": false, "type": "int", "unique": false, "updatable": true}, {"common": false, "default": "", "description": "\u7528\u6237\u540d\u79f0", "form_type": "input", "index": true, "insertable": true, "listable": true, "max_length": 100, "name": "user_name", "nullable": false, "options": null, "primary_key": false, "query_type": "like", "queryable": true, "required": true, "sortable": true, "type": "str", "unique": true, "updatable": true}, {"common": false, "default": "", "description": "\u7528\u6237\u7f16\u7801", "form_type": "input", "index": true, "insertable": true, "listable": true, "max_length": 50, "name": "user_code", "nullable": false, "options": null, "primary_key": false, "query_type": "like", "queryable": true, "required": true, "sortable": true, "type": "str", "unique": true, "updatable": true}, {"common": false, "default": null, "description": "\u5f00\u542f\u65e5\u671f", "form_type": "date", "index": false, "insertable": true, "listable": true, "max_length": null, "name": "open_date", "nullable": true, "options": null, "primary_key": false, "query_type": "in", "queryable": true, "required": false, "sortable": true, "type": "datetime", "unique": false, "updatable": true}, {"common": false, "default": null, "description": "\u7528\u6237\u72b6\u6001", "form_type": "select", "index": false, "insertable": true, "listable": true, "max_length": 128, "name": "user_status", "nullable": true, "options": [{"label": "\u542f\u7528", "value": "enabled"}, {"label": "\u505c\u7528", "value": "disabled"}], "primary_key": false, "query_type": null, "queryable": true, "required": false, "sortable": true, "type": "str", "unique": false, "updatable": true}, {"common": false, "default": null, "description": "\u5f00\u542f\u529f\u80fd", "form_type": "checkbox", "index": false, "insertable": true, "listable": true, "max_length": null, "name": "open_function", "nullable": true, "options": [{"label": "\u529f\u80fdA", "value": 1}, {"label": "\u529f\u80fdB", "value": 2}, {"label": "\u529f\u80fdC", "value": 3}], "primary_key": false, "query_type": null, "queryable": false, "required": false, "sortable": false, "type": "str", "unique": false, "updatable": true}, {"common": false, "default": null, "description": "\u7528\u6237\u4fe1\u606f", "form_type": "textarea", "index": false, "insertable": true, "listable": false, "max_length": 255, "name": "user_info", "nullable": true, "options": null, "primary_key": false, "query_type": null, "queryable": false, "required": false, "sortable": false, "type": "str", "unique": false, "updatable": true}];
...
function prepareInitialValues(record: Record<string, any>, fields: any[]) {
  ...
  fields.forEach((field) => {
    ...
    if (field.form_type === "date") {
      ...
      result[field.name] = date && typeof date.isValid === "function" && date.isValid() ? date : null;
...
function formatFormValues(values: any, fields: any[]) {
  const result: Record<string, any> = { ...values };
  fields.forEach((field) => {
    const value = result[field.name];
    if (field.form_type === "date") {
      // result[field.name] = value ? dayjs(value).format("YYYY-MM-DDTHH:mm:ss") : null;
    } else if (field.form_type === "checkbox") {
      result[field.name] = (value || []).join(",");
    }
  });
  console.log("Formatted values:", result);
  return result;
}

export const MulCurdModelUserEdit = () => {
  ...
  const handleFinish = (values: any) => {
    const processed = formatFormValues(values, fields);
