...
export const AppNew5Show = () => {
  ...
  return (
    <Show isLoading={isLoading}>
      ...
      <Text>
        {
          record?.api_base_url ? dayjs(record.api_base_url).format("YYYY-MM-DD") : ""
        }
      </Text>
      <br />
      ...
      <Text>
        {
          [{"label": "\u542f\u7528", "value": "enabled"}, {"label": "\u505c\u7528", "value": "disabled"}].find(opt => opt.value === record?.app_key)?.label || record?.app_key
        }
      </Text>
      <br />
