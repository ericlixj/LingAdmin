...
from app.codegen.processor import process_module_from_dict
...
@router.patch("/{item_id}", dependencies=[Depends(has_permission("crudDefineModuel:edit"))], response_model=CrudDefineModuel)
def update_item(
    item_id: int,
