...
from app.crud.sysDicData_crud import SysDicDataCRUD
from app.models.sysDicData import SysDicData, SysDicDataCreate, SysDicDataListResponse, SysDicDataUpdate
...
def list_items(
    ...
    if sortField and sortOrder:
        field = getattr(SysDicData, sortField, None)
...
def get_item(item_id: int, session: Session = Depends(get_session)):
    ...
    if not item:
        raise HTTPException(status_code=404, detail="SysDicData not found")
    return item
